...
(function () {
  ...
  .ggx-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }
  .ggx-grid a { display: flex; align-items: center; justify-content: center; gap: 8px; min-height: 58px;
    border-radius: 14px; border: 2px solid currentColor; background: rgba(127,127,127,.14);
    color: inherit; text-decoration: none; font-size: 18px; font-weight: 700; }
  ...
  .ggx-ico { font-size: 22px; line-height: 1; }
  `;
